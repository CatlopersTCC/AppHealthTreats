   ...
   final List<Produtos> produtos = [
    ...
    Produtos(
      ...
      comentarios: [
        ...
        Comentario(nome: 'Jailson Leite', desc: '', rating: 5),
        Comentario(nome: 'Rosimeire Domingues', desc: '.', rating: 4),
        Comentario(nome: 'Josilma Soares', desc: '.', rating: 3),
        Comentario(nome: 'Wilson Aquino Diniz', desc: '.', rating: 2),
        Comentario(nome: 'Betânia Jorgeana', desc: '.', rating: 1),
      ],
    ), 
    Produtos(
      ...
      desc: 'Descrição rápida',
      comentarios: [
        Comentario(nome: 'Rosita de Alencar', desc: '', rating: 5),
        Comentario(nome: 'Audálio Dantas', desc: '', rating: 5),
        Comentario(nome: 'Dora Oliveira', desc: '.', rating: 4),
        Comentario(nome: 'Pedro Amado', desc: '.', rating: 3),
        Comentario(nome: 'Matheus Secco', desc: '.', rating: 4),
        Comentario(nome: 'Weliington Cabello', desc: '.', rating: 1),
      ],
    ),  
    Produtos(
      ...
      desc: 'Descrição rápida',
      comentarios: [
        Comentario(nome: 'Nivia Furtado', desc: '', rating: 4),
        Comentario(nome: 'Ivonete de Naziazeno', desc: '', rating: 5),
        Comentario(nome: 'Olga Presidente', desc: '.', rating: 5),
        Comentario(nome: 'Fábian Ruiz', desc: '.', rating: 1),
        Comentario(nome: 'Alexandre Carrara', desc: '.', rating: 4),
        Comentario(nome: 'Estefânia Agostinho', desc: '.', rating: 5),
      ],
    ),
    Produtos(
      ...
      desc: 'Descrição rápida',
      comentarios: [
        Comentario(nome: 'Marcos Vieira', desc: '', rating: 4),
        Comentario(nome: 'Jorlan Barros', desc: '', rating: 5),
        Comentario(nome: 'Sheila Braz', desc: '.', rating: 5),
        Comentario(nome: 'Ruan da Rocha', desc: '.', rating: 1),
        Comentario(nome: 'Júnior de Amaral', desc: '.', rating: 4),
        Comentario(nome: 'Giovanne Militão', desc: '.', rating: 5),
      ],
    ),
    Produtos(
      nome: 'Coockie Branco',
      ...
      desc: 'Descrição rápida',
      comentarios: [
        Comentario(nome: 'Thaís Magalhães', desc: '', rating: 4),
        Comentario(nome: 'Millenna Lira', desc: '', rating: 5),
        Comentario(nome: 'Óscar Reymond', desc: '.', rating: 5),
        Comentario(nome: 'Bruna Pompeo Lima', desc: '.', rating: 1),
        Comentario(nome: 'Wendell de Castro', desc: '.', rating: 4),
        Comentario(nome: 'Amanda Marquezine', desc: '.', rating: 5),
      ],
    ),
  ];
